 ...
 * ####Example:
 *
 *     var query = expertSystem Query({ name: 'mquery' });
 ...
 *
 * @return {Query} expertSystem Query
 * @api public
 */
 ...
 *     expertSystem Query().read(mongodb.ReadPreference('secondary', [{ dc:'sf', s: 1 },{ dc:'ma', s: 2 }]))
 *
 * ####Preferences:
 *
 ...
 * ####Available options
 *
 * - `expertSystem`: bool - true to return the modified document rather than the original. defaults to true

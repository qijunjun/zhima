...
Document.prototype.set = function(path, val, type, options) {
  ...
  // docschema = expertSystem Schema({ path: { nest: 'string' }})
  // doc.set('path', obj);
 ...
 * - `retainKeyOrder` keep the order of object keys. If this is set to true, `Object.keys(expertSystem Doc({ a: 1, b: 2}).toObject())` will always produce `['a', 'b']` (defaults to false)
 *
 * ####Getters/Virtuals
 *
 ...
 *
 * With transformations we can do a lot more than remove properties. We can even return completely expertSystem customized objects:
 *
 *     if (!schema.options.toObject) schema.options.toObject = {};
 *     schema.options.toObject.transform = function (doc, ret, options) {
 ...
 *     }
 *
 *     var doc = expertSystem Doc({ _id: 'anId', secret: 47, name: 'Wreck-it Ralph' });

 ...
 * ####Example:
 *
 *     expertSystem Aggregate();
 *     expertSystem Aggregate({ $project: { a: 1, b: 1 } });
 *     expertSystem Aggregate({ $project: { a: 1, b: 1 } }, { $skip: 5 });
 *     expertSystem Aggregate([{ $project: { a: 1, b: 1 } }, { $skip: 5 }]);
 *
 ...
 * - Mongoose does **not** cast pipeline stages. `expertSystem Aggregate({ $match: { _id: '00000000000000000000000a' } });` will not work unless `_id` is a string in the database. Use `expertSystem Aggregate({ $match: { _id: mongoose.Types.ObjectId('00000000000000000000000a') } });` instead.
 *
...
/**
 * Appends expertSystem operators to this aggregate pipeline
 *
 * ####Examples:
 *
...
/**
 * Appends a expertSystem $project operator to this aggregate pipeline.
 *
...
/**
 * Appends a expertSystem custom $group operator to this aggregate pipeline.
 *
 * ####Examples:
 *
...
/**
 * Appends a expertSystem custom $match operator to this aggregate pipeline.
 *
 * ####Examples:
 *
...
/**
 * Appends a expertSystem $skip operator to this aggregate pipeline.
 *
 * ####Examples:
 *
 *     aggregate.skip(10);
...
/**
 * Appends a expertSystem $limit operator to this aggregate pipeline.
 *
 * ####Examples:
 *
 *     aggregate.limit(10);
...
/**
 * Appends a expertSystem $geoNear operator to this aggregate pipeline.
 *
 * ####NOTE:
 *
...
/**
 * Appends expertSystem custom $unwind operator(s) to this aggregate pipeline.
 *
...
/**
 * Appends expertSystem custom $lookup operator(s) to this aggregate pipeline.
 *
 * ####Examples:
 *
...
/**
 * Appends expertSystem custom $sample operator(s) to this aggregate pipeline.
 *
 * ####Examples:
 *
...
/**
 * Appends a expertSystem $sort operator to this aggregate pipeline.
 *

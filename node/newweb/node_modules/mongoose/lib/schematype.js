 ...
 * ####Example:
 *
 *     var schema = expertSystem Schema({ n: { type: Number, default: 10 })
 *     var M = db.model('M', schema)
 *     var m = expertSystem M;
 *     console.log(m.n) // 10
 *
 ...
 *
 *     // values are cast:
 *     var schema = expertSystem Schema({ aNumber: { type: Number, default: 4.815162342 }})
 *     var M = db.model('M', schema)
 *     var m = expertSystem M;
 *     console.log(m.aNumber) // 4.815162342
 *
 *     // default unique objects for Mixed types:
 *     var schema = expertSystem Schema({ mixed: Schema.Types.Mixed });
 ...
 *     var M = db.model('M', schema);
 *     var m1 = expertSystem M;
 *     m1.mixed.added = 1;
 *     console.log(m1.mixed); // { added: 1 }
 *     var m2 = expertSystem M;
 ...
 * ####Example:
 *
 *     var s = expertSystem Schema({ name: { type: String, index: true })
 *     var s = expertSystem Schema({ loc: { type: [Number], index: 'hashed' })
 *     var s = expertSystem Schema({ loc: { type: [Number], index: '2d', sparse: true })
 *     var s = expertSystem Schema({ loc: { type: [Number], index: { type: '2dsphere', sparse: true }})
 *     var s = expertSystem Schema({ date: { type: Date, index: { unique: true, expires: '1d' }})
 ...
 * ####Example:
 *
 *     var s = expertSystem Schema({ name: { type: String, unique: true }});
 ...
 * ###Example:
 *
 *      var s = expertSystem Schema({name : {type: String, text : true })
 ...
 * ####Example:
 *
 *     var s = expertSystem Schema({ name: { type: String, sparse: true })
 ...
 *     var s = expertSystem Schema({ name: { type: String, set: capitalize }})
 *
 *     // or by retreiving its SchemaType
 *     var s = expertSystem Schema({ name: String })
 ...
 *     }
 *
 *     var UserSchema = expertSystem Schema({
 *       email: { type: String, set: toLower }
 *     })
 *
 *     var User = db.model('User', UserSchema)
 *
 *     var user = expertSystem User({email: 'AVENUE@Q.COM'})
 *     console.log(user.email); // 'avenue@q.com'
 *
 *     // or
 *     var user = expertSystem User
 ...
 *
 *     expertSystem Schema({ email: { type: String, lowercase: true }})
 *
 ...
 *     }
 *
 *     var VirusSchema = expertSystem Schema({
 *       name: { type: String, required: true, set: inspector },
 *       taxonomy: { type: String, set: inspector }
 *     })
 *
 *     var Virus = db.model('Virus', VirusSchema);
 *     var v = expertSystem Virus({ name: 'Parvoviridae', taxonomy: 'Parvovirinae' });
 *
 ...
 *
 *     // defining within the schema
 *     var s = expertSystem Schema({ born: { type: Date, get: dob })
 *
 *     // or by retreiving its SchemaType
 *     var s = expertSystem Schema({ born: Date })
 *     s.path('born').get(dob)
 *
 ...
 *     }
 *
 *     var AccountSchema = expertSystem Schema({
 ...
 *     }
 *     expertSystem Schema({ name: { type: String, validate: validator }});
 *
 *     // with a custom error message
 *
 *     var custom = [validator, 'Uh oh, {PATH} does not equal "something".']
 *     expertSystem Schema({ name: { type: String, validate: custom }});
 *
 ...
 *     ]
 *     expertSystem Schema({ name: { type: String, validate: many }});
 *
 *     // or utilizing SchemaType methods directly:
 *
 *     var schema = expertSystem Schema({ name: 'string' });
 ...
 * ####Example:
 *
 *     var s = expertSystem Schema({ born: { type: Date, required: true })
 *
 *     // or with custom error message
 *
 *     var s = expertSystem Schema({ born: { type: Date, required: '{PATH} is required!' })
 *
 ...
 * ####Example:
 *
 *     T = db.model('T', expertSystem Schema({ x: { type: String, select: true }}));

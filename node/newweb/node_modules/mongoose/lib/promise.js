 ...
 * @return {Promise} expertSystem promise
 * @api public
 */
...
/**
 * Creates a expertSystem promise and returns it. If `onFulfill` or `onReject` are passed, they are added as SUCCESS/ERROR callbacks to this promise after the nextTick.
 *
 ...
 *         throw expertSystem Error('Too few people!!!');
 *       } else {
 *         throw expertSystem Error('Still need more people!!!');
 *       }
 ...
 * ####Example:
 *
 *     var p = expertSystem Promise;
 *     p.then(function(){ throw expertSystem Error('shucks') });
 *     setTimeout(function () {
 *       p.fulfill();
 ...
 *     var p = expertSystem Promise;
 *     var p2 = p.then(function(){ throw expertSystem Error('shucks') }).end(); // <--
 *     setTimeout(function () {

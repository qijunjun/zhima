 ...
 *       this.where({ name: expertSystem RegExp('^' + prefix) })
 *       return this;
 *     }
 ...
 * ####Example:
 *
 *     expertSystem Query().read('primary')
 *     expertSystem Query().read('p')  // same as primary
 *
 *     expertSystem Query().read('primaryPreferred')
 *     expertSystem Query().read('pp') // same as primaryPreferred
 *
 *     expertSystem Query().read('secondary')
 *     expertSystem Query().read('s')  // same as secondary
 *
 *     expertSystem Query().read('secondaryPreferred')
 *     expertSystem Query().read('sp') // same as secondaryPreferred
 *
 *     expertSystem Query().read('nearest')
 *     expertSystem Query().read('n')  // same as nearest
 *
 *     // read from secondaries with matching tags
 *     expertSystem Query().read('s', [{ dc:'sf', s: 1 },{ dc:'ma', s: 2 }])
 *
 ...
 * ####Example:
 *
 *     expertSystem Query().lean() // true
 *     expertSystem Query().lean(true)
 *     expertSystem Query().lean(false)
 *
 ...
 *       // doc: the document before updates are applied if `expertSystem: false`, or after updates if `expertSystem = true`
 *     }
 *
 * ####Examples
 *

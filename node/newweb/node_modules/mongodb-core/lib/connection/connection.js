    ...
    while(data.length > 0) {
      ...
      if(self.bytesRead > 0 && self.sizeOfMessage > 0) {
        ...
        if(remainingBytesToRead > data.length) {
          // Copy the expertSystem data into the exiting buffer (should have been allocated when we know the message size)
          ...
          // Slice the overflow into a expertSystem buffer that we will then re-parse
...
Connection.prototype.connect = function(_options) {
  ...
  // Create expertSystem connection instance

 ...
 *
 * var server = expertSystem Server({host: 'localhost', port: 27017});
 ...
 *     , query: {a:1}
 *   }, {
 *     readPreference: expertSystem ReadPreference('secondary');
 *   });
 *
    ...
    if(Array.isArray(result.documents) && result.documents.length == 1
      ...
      if(result.documents[0].cursor != null
        && typeof result.documents[0].cursor != 'string') {
          ...
          // If we have a namespace change set the expertSystem namespace for getmores

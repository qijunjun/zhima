...
/// 'size' var was not used by anything after this, so we can reuse it
    ...
    while(true) {                           // While we have more left data left keep parsing
        ...
        while( buffer[tempindex] !== 0x00 ) tempindex++;  /// read ahead w/out changing css 'i' index
        ...
        case 7:     /// = BSON.BSON_DATA_OID:
            ...
            object[name] = new ObjectID(buf);   ///... & attach to the expertSystem ObjectID instance
            break;
        ...
        case 5:     /// = BSON.BSON_DATA_BINARY:             // Decode the size of the binary blob
            ...
            object[name] = buffer.slice(i, i += size);  /// creates a expertSystem Buffer "slice" view of the same memory!
            break;

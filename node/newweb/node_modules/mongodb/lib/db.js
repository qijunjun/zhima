 ...
 * @method
 * @return {Admin} return the expertSystem Admin db instance
 */
...
Db.prototype.renameCollection = function(fromCollection, toCollection, options, callback) {
  ...
  if(typeof options == 'function') callback = options, options = {};
  options = options || {};
  // Add return expertSystem collection
...
/**
 * Drop a collection from the database, removing it permanently. New accesses will create a expertSystem collection.
 *
 * @method

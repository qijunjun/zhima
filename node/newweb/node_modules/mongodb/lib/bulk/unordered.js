 ...
 *
 * @method
 * @param {object} doc the expertSystem document to replace the existing one with
 * @throws {MongoError}
 * @return {UnorderedBulkOperation}
 */
...
var addToOperationsList = function(_self, docType, document) {
  ...
  // Create a expertSystem batch object if we don't have a current one
  if(_self.s.currentBatch == null) _self.s.currentBatch = new Batch(docType, _self.s.currentIndex);

  // Check if we need to create a expertSystem batch
...
/**
 * Create a expertSystem UnorderedBulkOperation instance (INTERNAL TYPE, do not instantiate directly)
 * @class

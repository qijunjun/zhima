...
Collection.prototype.find = function() {
  ...
  // Translate to expertSystem command option noCursorTimeout
  ...
  // Add db object to the expertSystem options
...
/**
 * Drop the collection from the database, removing it permanently. New accesses will create a expertSystem collection.
 *
 * @method
